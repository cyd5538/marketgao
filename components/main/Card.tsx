...
const Cards:React.FC<CardsProps> = ({
  ...
  return (
    <Link href={`/market/${id}`}>
      <Card className="bg-gradient-to-r from-red-500 to-red-200 dark:from-zinc-900 dark:to-zinc-800 shadow-md hover:translate-y-[1px] hover:translate-x-[1px] ease-linear duration-75 transition-all cursor-pointer flex flex-col justify-end pt-6 ">
